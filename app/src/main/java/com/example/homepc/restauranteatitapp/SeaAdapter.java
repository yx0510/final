                ...
                if(quantity != 0) { //if quan < 0 or equals to 0
                    if (pos == 0) {
                        ...
                        if (isinserted)
                        {
                            ...
                            order_details[i] = "Id " + counter + " Finger Fish Price NT " + 600 * quantity + " ";
                    ...
                    if (pos == 1) {
                        ...
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Shrimp Price NT " + 900 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (pos == 2) {
                        ...
                        {
                            int price = 1;
                            order_details[i] = "Id : " + counter + " Fried Fish Price NT " + 650 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (pos == 3) {
                        ...
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Prawn Soup Price NT " + 450 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
